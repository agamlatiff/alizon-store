...
const SignUpPage = () => {
  const [state, formAction] = useFormState(signUp, initiaFormState);
  return (
    <div
      id="signin"
      ...
      <div className="container max-w-[1130px] mx-auto flex flex-1 items-center justify-center py-5">
        ...
        >
          <div className="flex justify-center">
            <Image height={200} width={200} src="assets/logos/logo-black.svg" alt="logo" />
          </div>
          ...
          <div className="flex items-center gap-[10px] rounded-full border border-[#E5E5E5] p-[12px_20px] focus-within:ring-2 focus-within:ring-[#FFC736] transition-all duration-300">
            <div className="flex shrink-0">
              <Image height={25} width={25} src="assets/icons/profile-circle.svg" alt="icon" />
            </div>
            <input
              type="text"
              id="name"
          ...
          <div className="flex items-center gap-[10px] rounded-full border border-[#E5E5E5] p-[12px_20px] focus-within:ring-2 focus-within:ring-[#FFC736] transition-all duration-300">
            <div className="flex shrink-0">
              <Image height={25} width={25} src="assets/icons/sms.svg" alt="icon" />
            </div>
            <input
              type="email"
              id="email"
          ...
          <div className="flex flex-col gap-[10px]">
            <div className="flex items-center gap-[10px] rounded-full border border-[#E5E5E5] p-[12px_20px] focus-within:ring-2 focus-within:ring-[#FFC736] transition-all duration-300">
              <div className="flex shrink-0">
                <Image height={25} width={25} src="assets/icons/lock.svg" alt="icon" />
              </div>
              <input
                type="password"
                id="password"
